...
public class FastCollectionSet<T extends Serializable> implements Set<T>, Closeable {
    ...
    /**
     * Create or open a set with default settings.
     * 
    ...
    /**
     * Create or open a set with custom settings.
     * 
     * @param filePath path to the memory-mapped file
    ...
    /**
     * Get remaining TTL for an element.
     * 
     * @param element the element
     * @return remaining TTL in seconds, -1 if infinite, 0 if not found/expired
     */
    @SuppressWarnings("unchecked")
    public long getTTL(T element) { checkClosed(); return nativeGetTTL(nativeHandle, serialize(element)); }
    
    /**
     * Update TTL for an element.
     * 
     * @param element the element
     * @param ttlSeconds new TTL in seconds (-1 for infinite)
     * @return true if element exists and TTL updated
     */
    ...
    /**
     * Get the file path for this set.
     * 
