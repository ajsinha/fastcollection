...
public class FastCollectionAllTest {
    ...
    class SetTests {
        ...
        void setUp() {
            ...
            set = new FastCollectionSet<>(TEST_FILE, 16 * 1024 * 1024, true);
        }
    ...
    class QueueTests {
        ...
        void setUp() {
            new File(TEST_FILE).delete();
            queue = new FastCollectionQueue<>(TEST_FILE, 16 * 1024 * 1024, true);
        }
    ...
    class StackTests {
        ...
        void setUp() {
            new File(TEST_FILE).delete();
            stack = new FastCollectionStack<>(TEST_FILE, 16 * 1024 * 1024, true);
        }
